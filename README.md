...
Student Name: RODGERS SINKAMBA
Student ID: 2511400967
Course: Interactive Web Development
Assignment: HTML Personal Website Development Assignment
...
A header containing the website title and introduction.
A navigation menu for moving between sections.
An About Me section.
...
semantic HTML elements  were used to give meaning to different parts of the pages.

<header> contains the introductory content and main navigation.
<nav> contains the navigation links.
<main> contains the primary content of the website.
<section> divides the main content into logical areas such as About, Education, Skills, Projects and Contact.
<article> contains self-contained pieces of information, such as individual projects.
<figure> and <figcaption> group an image with its explanation.
<address> identifies contact information.
<footer> contains the closing information and additional navigation.
...
I first identified the purpose of the website and decided that it would be a personal portfolio website. I then divided the content into major sections: About Me, Education, Skills, Projects and Contact.

After that, I planned the document hierarchy:

<html>, <head>, <body>, <header>, <nav>, <main>, <sections> <articles>, and <footer>
...
I tested the website by opening the HTML file in a web browser and checking whether:

The page loaded correctly.
All headings and paragraphs appeared in the correct order.
Navigation links moved to the correct pages.
The image displayed correctly.
The contact form controls appeared correctly.
Links opened their intended destinations.
Required form fields behaved as expected.
The HTML structure was properly nested.
...
I checked that every element was properly opened and closed where required. I also checked the nesting of elements, quotation marks around attribute values, working internal links and appropriate form labels.
...
Adding more projects and project screenshots.
Improving accessibility through additional testing with accessibility tools.
Adding a downloadable CV.
Creating separate pages for selected projects.